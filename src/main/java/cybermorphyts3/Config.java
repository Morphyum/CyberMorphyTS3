...
public class Config {
	public static int SERVERGROUP_ADMIN = 12;
	public static String WELCOMEMESSAGE = "Willkommen im Morphspeak ich bin ihr freundlicher bot, wenn sie neu auf dem Server sind bitte antworten sie mit "
